...
@section ('title', 'Tile Management' . ' | ' . 'Create Tile')
...
@section('page-header')
    <h1>
        Tile Management
        <small>Create Tile</small>
    </h1>
@endsection

@section('content')
        {{ Form::open(['route' => 'admin.tile.store', 'id' => 'tilecreateform', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::text('tilename', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'autofocus' => 'autofocus', 'placeholder' => 'Tile Name']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                ...
                <div class="form-group" style="margin-bottom: 40px; margin-top: 40px;">
                    ...
                    <div class="col-lg-10">
                        <div class="checkbox-container">
                            <input type="checkbox" id="optpost" name="optpost">
                        </div>
                    </div><!--col-lg-10-->
                </div><!--form control-->
                    ...
                    <div class="col-lg-10">
                        <div class="box box-warning box-solid" style="max-width: 600px;">
                            <div class="box-body tilebox">
                                <div id="tileimage" class="tileimage" style="background-image: url({{asset('img/tiles/sampletile.png')}});"></div>
                            </div>
                        </div>
...
@section('after-scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#tilecreateform").submit(function(evt){
                if(tile.files.length == 0)
                {
                    swal({
                        title: "Choose image for the tile.",
                        type: "error",
